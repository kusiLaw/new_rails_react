...
> Hello world is a simple that setup rails as a backend and react as front end usig API.
...
- Create redux for state management
- setup api 
...
```sh
  cd my-folder
  git clone git@github.com:kusiLaw/new_rails_react.git
```
...
- [x] Create redux for state management
- [x] setup api
